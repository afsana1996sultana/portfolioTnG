				...
				<form action="{{route('count.store')}}" method="post" enctype="multipart/form-data">
					...
					<div class="row">
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								<div class="col-sm-2">
									<label class="col-form-label">Support:&nbsp;<span class="text-danger">*</span></label>
								</div>
								<div class="col-sm-10">
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								<div class="col-sm-2">
									<label class="col-form-label">Workers:&nbsp;<span class="text-danger">*</span></label>
								</div>
								<div class="col-sm-10">
