                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="Browser: activate to sort column ascending">Logo</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="Platform(s): activate to sort column ascending">Created Date</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                aria-label="Engine version: activate to sort column ascending">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($frontlogo as $key=> $frontlogo)
                            <tr class="odd">
                                <td>{{ $key+1 }}</td>
                                <td>
                                    <img src="{{ asset('img/' . $frontlogo->logo_img) }}" height="50px" width="155px"
                                        alt="">
                                </td>
                                <td>{{ $frontlogo->created_at }}</td>
                                <td class="text-right py-0 align-middle">
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" value="{{ $frontlogo->id }}" class="btn btn-primary"
                                            id="editfrontlogo"><i class="fas fa-pencil-alt"></i> </button>&nbsp;
                                    </div>
                                </td>
                            </tr>
                        @empty
                ...
                <div class="modal-body">
                    <form action="{{ route('frontlogo.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-5">
                                    <img src="{{ url('backend/assets/photo/av.jpg') }}" alt="" sizes=""
                                        srcset="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="submit-section float-right">
                            ...
                            <input class="btn btn-primary submit-btn" type="submit" name="btnCreate"
                                style="width:80px;" value="Add">
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="input-group mb-3">
                                    ...
                                    <label class="col-form-label">Logo:&nbsp;</label>
                                    <input type="file" class="form-control" name="fileLogo" placeholder="logo"
                                        required><br>
                                </div>
                        ...
                        <div class="row float-right">
                            ...
                            <div class="col-6">
                                <a href="javascript:void(0);" data-dismiss="modal"
                                    class="btn btn-info cancel-btn">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
