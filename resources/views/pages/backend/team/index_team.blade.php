        ...
        <div class="col-sm-12">
            <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                ...
                <tbody> 
                    ...
                    <tr class="odd">
                        <td>{{ $key+1 }}</td>
						<td><img src="{{ asset('img/' . $team->image) }}" height="110px" width="150px" alt=""></td>
                        <td>{{$team-> name}}</td>
					...
					<div class="row">
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="txtLinkedin" name="txtLinkedin">
								</div>
							</div>
						</div>
					...
					<div class="row">
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="eTwitter" name="txtTwitter">
								</div>
							</div>
						</div>
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="eFacebook" name="txtFacebook">
								</div>
							</div>
						</div>
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="eInstagram" name="txtInstagram">
								</div>
							</div>
						</div>
                        ...
                        <div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="eLinkedin" name="txtLinkedin">
								</div>
							</div>
						</div>
