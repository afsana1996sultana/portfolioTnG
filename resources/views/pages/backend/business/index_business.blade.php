...
<div class="card-body">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0">Scope Of Business</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-group mb-5">
								<div class="col-sm-3">
									<label class="col-form-label">Business Unit Name:&nbsp;<span class="text-danger">*</span></label>
								</div>
								<div class="col-sm-9">
						...
						<div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtOtherTitle" name="txtOtherTitle">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="input-group mb-5">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="txtOtherHeading" name="txtOtherHeading">
								</div>
							</div>
						</div>
