    ...
    <div class="page-header flex-middle">
        <div class="container">
            <div class="inner flex-middle">
                <h1 class="page-title" style="font-weight:600; text-align: center;">All Products</h1>
            </div>
        </div>
    </div>
    ...
    <section class="contact-page" style="padding-top: 40px; padding-bottom: 40px;">
        <div class="container">
            {{-- <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12  project-item {{ $product->child_menu_id }}">
                    <a href="{{ route('singleProduct', ['id' => $product->id]) }}" class="single__product__info text-center">
                        <div class="product__photo">
                            <img class="w-100 p-3" src="{{ asset($product->fitureImg) }}" alt="{{ $product->title }}" />
                        </div>
